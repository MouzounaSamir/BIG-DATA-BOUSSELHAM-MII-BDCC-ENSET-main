...
**Module :** Big Data - PySpark Structured Streaming &nbsp;&nbsp;
...
![Conteneurs Docker démarrés](screenshots/1.png)
...
![Spark Master UI — Cluster prêt](screenshots/2.png)
...
![YARN ResourceManager](screenshots/8.png)
...
![Création des répertoires HDFS](screenshots/3.png)
...
![Schéma des données Spark](screenshots/10.png)
...
![Spark Master UI — Application en cours](screenshots/4.png)
...
![Injection des CSV dans HDFS](screenshots/11.png)
...
![Vérification des checkpoints HDFS](screenshots/9.png)
